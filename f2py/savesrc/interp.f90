...
!******************************************************************
  ...
  !arrays
  integer*4,allocatable :: i0_tilde(:,:),j0_tilde(:,:)
  integer*1,allocatable :: ip_tilde(:,:),jp_tilde(:,:)
  real*8,allocatable    :: xtilde0(:,:),ytilde0(:,:)
  real*8,allocatable    ::cos_beta_ref(:,:),sin_beta_ref(:,:)
  real*8,allocatable    :: glon(:,:),glat(:,:),glon_an(:,:),glat_an(:,:)
...
!$$$ end documentation block
  ...
  real*8,allocatable:: clata(:,:),slata(:,:),clona(:,:),slona(:,:)

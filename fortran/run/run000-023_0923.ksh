...
FHMIN_GFS=000 #start hour (6, 12, 18, 24, 30, 36, etc). 
FHMAX_GFS=023 #end  hour (6, 12, 18, 24, 30, etc). FHMIN = FHMAX if simulating obs for single cyc (1 bufr file).

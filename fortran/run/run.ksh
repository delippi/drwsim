...
#23,47,71,95,119,143,167,171
FHMIN_GFS=168 #start hour (6, 12, 18, 24, 30, 36, etc). 
FHMAX_GFS=171 #end  hour (6, 12, 18, 24, 30, etc). FHMIN = FHMAX if simulating obs for single cyc (1 bufr file).
